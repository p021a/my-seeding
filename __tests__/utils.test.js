...
describe.only("createRef", () => {
  test("should return an empty object when passed empty array", () => {
    const input = [];
    const result = createRef(input);
    expect(result).toEqual({});
  });

  test("should return a ref object with single key and value when passed an array containing a single article object", () => {
    const input = [
      {
        article_id: 1,
